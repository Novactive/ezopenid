...
{if $User:warning.bad_login}
    <div class="message-warning">
        <h2><span class="time">[{currentdate()|l10n( shortdatetime )}
                ]</span> {'The system could not log you in.'|i18n( 'design/admin/user/login' )}</h2>
        <ul>
...
{else}
    {if $site_access.allowed|not}
        <div class="message-warning">
            <h2><span class="time">[{currentdate()|l10n( shortdatetime )}
                    ]</span> {'Access denied!'|i18n( 'design/admin/user/login' )}</h2>
            <ul>
        ...
        <div class="login-inputs context-attributes">
            ...
            <div class="block">
                <div class="login-input-wrapper">
                    ...
                    <input class="halfbox" type="text" autofocus="autofocus" size="10" name="Login" id="logintext"
                           placeholder="{'Username'|i18n( 'design/admin/user/login' )}" tabindex="1"
            ...
            <div class="block">
                <div class="login-input-wrapper">
                    ...
                    <input class="halfbox" type="password" size="10" name="Password" id="passwordtext"
                           placeholder="{'Password'|i18n( 'design/admin/user/login' )}" tabindex="2"
            ...
            {if and( ezini_hasvariable( 'Session', 'RememberMeTimeout' ), ezini( 'Session', 'RememberMeTimeout' ) )}
                <div class="block login-text-wrapper">
                    <input type="checkbox" name="Cookie" id="id3"/><label for="id3"
                                                                          style="display:inline;">{"Remember me"|i18n("design/admin/user/login")}</label>
                </div>
            {/if}
        </div>
        <div class="controlbar">
            ...
            <div class="box-bc">
                <div class="box-ml">
                    <div class="block">
                        <div class="login-input-wrapper">
                            <input class="defaultbutton" type="submit" id="loginbutton" name="LoginButton"
                                   value="{'Log in'|i18n( 'design/admin/user/login', 'Login button' )}" tabindex="3"
                                   title="{'Click here to log in using the username/password combination entered in the fields above.'|i18n( 'design/admin/user/login' )}"/>
                        </div>
